...
fn zh(key: &'static str) -> &'static str {
    match key {
        ...
        "Save" => "保存",
        "Save theme" => "保存主题",
        "Save theme and language" => "保存主题和语言",
        "Scanning" => "扫描中",
        "Screen" => "屏幕",
        ...
        "Theme and language saved." => "主题和语言已保存。",
        "Testing..." => "测试中...",
...
mod tests {
    ...
    #[test]
    fn reverse_proxy_i18n_keys_have_chinese_translations() {
        for key in [
            "Accept failed: {error}",
            "Admin network queue is closed",
            "Address type not supported",
            "Already listening",
            "Clear Closed",
            "Clone local socket failed: {error}",
            "Clone target stream failed: {error}",
            "Closed",
            "Closing",
            ...
            "Host unreachable",
            "Invalid listen port",
            "Invalid test target port",
            "Invalid SOCKS domain name",
            "Invalid SOCKS reply",
            "Killed by admin",
            "Kill Selected",
            "Listen failed: {error}",
            ...
            "Local side closed",
            "Local SOCKS client disconnected",
            "Local socket closed",
            "Network unreachable",
            "No connections",
            "Only SOCKS5 CONNECT is supported",
            "Opening",
            "Proxy data arrived before open result",
            "Proxy endpoint has no address",
            "Proxy open result channel closed",
            "Proxy open timed out",
            "Proxy stopped",
            "Proxy stream closed",
            "Proxy stream is not open",
            "Proxy target writer stopped",
            ...
            "SOCKS request timed out",
            "Start proxy before testing",
            "Starting",
            "State",
            "Stopping",
            "Succeeded",
            "Target",
            "Target closed",
            "Target read failed: {error}",
            "Target write failed: {error}",
            "Test",
            "Test failed: {error}",
            "Test SOCKS5 through {target}",
            "Test succeeded: {target}",
            "Test target host:port",
            "Test target host is too long",
            "Test target is required",
            "Test target must be host:port",
            "Testing...",
            "Testing connection to {target}",
            "Time",
            "Tx",
            "Unassigned SOCKS reply code",
            "Unsupported SOCKS address type",
            "Unsupported SOCKS version",
            "Unsupported SOCKS reply address type",
            "Use brackets for IPv6 test targets",
        ] {
            assert_ne!(zh(key), key, "missing reverse proxy i18n key: {key}");
        }
    }
}
